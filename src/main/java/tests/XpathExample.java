...
public class XpathExample extends BaseTest {
	...
	public void xpathExampleTest() throws InterruptedException {
		...
		jse.executeScript("arguments[0].setAttribute('style', 'background: green;border:6px solid green;')", userField);
		userField.sendKeys(user);
		
		//AND
		WebElement passField = driver.findElement(By.xpath("//input[@type='password' and @name='pwd']"));
		jse.executeScript("arguments[0].setAttribute('style', 'background: green;border:6px solid green;')", passField);
